...
class SessionTableMap extends TableMap
{
     ...
     */
    const COL_SESSION = 'session.session';

    /**
     * the column name for the userid field
     */
    const COL_USERID = 'session.userid';

    /**
     * the column name for the starttime field
     */
    const COL_STARTTIME = 'session.starttime';

    /**
     * the column name for the currenttime field
     */
    const COL_CURRENTTIME = 'session.currenttime';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Session', 'Userid', 'Starttime', 'Currenttime', ),
        self::TYPE_CAMELNAME     => array('id', 'session', 'userid', 'starttime', 'currenttime', ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID, SessionTableMap::COL_SESSION, SessionTableMap::COL_USERID, SessionTableMap::COL_STARTTIME, SessionTableMap::COL_CURRENTTIME, ),
        self::TYPE_FIELDNAME     => array('id', 'session', 'userid', 'starttime', 'currenttime', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Session' => 1, 'Userid' => 2, 'Starttime' => 3, 'Currenttime' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'session' => 1, 'userid' => 2, 'starttime' => 3, 'currenttime' => 4, ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID => 0, SessionTableMap::COL_SESSION => 1, SessionTableMap::COL_USERID => 2, SessionTableMap::COL_STARTTIME => 3, SessionTableMap::COL_CURRENTTIME => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'session' => 1, 'userid' => 2, 'starttime' => 3, 'currenttime' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id', 'Id', 'BIGINT', true, 40, null);
        $this->addColumn('session', 'Session', 'BIGINT', true, 40, 0);
        $this->addColumn('userid', 'Userid', 'TINYINT', true, null, 0);
        $this->addColumn('starttime', 'Starttime', 'BIGINT', true, 40, 0);
        $this->addColumn('currenttime', 'Currenttime', 'BIGINT', true, 40, 0);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionTableMap::COL_SESSION);
            $criteria->addSelectColumn(SessionTableMap::COL_USERID);
            $criteria->addSelectColumn(SessionTableMap::COL_STARTTIME);
            $criteria->addSelectColumn(SessionTableMap::COL_CURRENTTIME);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.session');
            $criteria->addSelectColumn($alias . '.userid');
            $criteria->addSelectColumn($alias . '.starttime');
            $criteria->addSelectColumn($alias . '.currenttime');
        }
    }
