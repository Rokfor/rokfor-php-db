...
abstract class Session implements ActiveRecordInterface
{
    ...
    /**
     * Get the [currenttime] column value.
     *
     * @return string
     */
    ...
    public function setSession($v)
    {
        ...
        if ($this->session !== $v) {
            $this->session = $v;
            $this->modifiedColumns[SessionTableMap::COL_SESSION] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[SessionTableMap::COL_USERID] = true;
        }
    ...
    public function setStarttime($v)
    {
        ...
        if ($this->starttime !== $v) {
            $this->starttime = $v;
            $this->modifiedColumns[SessionTableMap::COL_STARTTIME] = true;
        }
    ...
    /**
     * Set the value of [currenttime] column.
     *
     * @param string $v new value
     * @return $this|\Session The current object (for fluent API support)
     */
    public function setCurrenttime($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->currenttime !== $v) {
            $this->currenttime = $v;
            $this->modifiedColumns[SessionTableMap::COL_CURRENTTIME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SessionTableMap::translateFieldName('Session', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SessionTableMap::translateFieldName('Starttime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->starttime = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SessionTableMap::translateFieldName('Currenttime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->currenttime = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = SessionTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_SESSION)) {
            $modifiedColumns[':p' . $index++]  = 'session';
        }
        if ($this->isColumnModified(SessionTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userid';
        }
        if ($this->isColumnModified(SessionTableMap::COL_STARTTIME)) {
            $modifiedColumns[':p' . $index++]  = 'starttime';
        }
        if ($this->isColumnModified(SessionTableMap::COL_CURRENTTIME)) {
            $modifiedColumns[':p' . $index++]  = 'currenttime';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'session':
                        $stmt->bindValue($identifier, $this->session, PDO::PARAM_INT);
                        break;
                    case 'userid':
                        $stmt->bindValue($identifier, $this->userid, PDO::PARAM_INT);
                        break;
                    case 'starttime':
                        $stmt->bindValue($identifier, $this->starttime, PDO::PARAM_INT);
                        break;
                    case 'currenttime':
                        $stmt->bindValue($identifier, $this->currenttime, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getSession(),
            $keys[2] => $this->getUserid(),
            $keys[3] => $this->getStarttime(),
            $keys[4] => $this->getCurrenttime(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setCurrenttime($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_SESSION)) {
            $criteria->add(SessionTableMap::COL_SESSION, $this->session);
        }
        if ($this->isColumnModified(SessionTableMap::COL_USERID)) {
            $criteria->add(SessionTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(SessionTableMap::COL_STARTTIME)) {
            $criteria->add(SessionTableMap::COL_STARTTIME, $this->starttime);
        }
        if ($this->isColumnModified(SessionTableMap::COL_CURRENTTIME)) {
            $criteria->add(SessionTableMap::COL_CURRENTTIME, $this->currenttime);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCurrenttime($this->getCurrenttime());
        if ($makeNew) {
            $copyObj->setNew(true);
