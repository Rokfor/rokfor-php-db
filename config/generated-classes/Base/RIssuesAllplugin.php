...
/**
 * Base class that represents a row from the 'R_issues_allplugin' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class RIssuesAllplugin implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RIssuesAllpluginTableMap';
    ...
    /**
     * Initializes internal state of Base\RIssuesAllplugin object.
     */
    ...
    /**
     * Compares this with another <code>RIssuesAllplugin</code> instance.  If
     * <code>obj</code> is an instance of <code>RIssuesAllplugin</code>, delegates to
     * <code>equals(RIssuesAllplugin)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RIssuesAllplugin The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RIssuesAllpluginTableMap::translateFieldName('Issueid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->_issueid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RIssuesAllpluginTableMap::translateFieldName('Pluginid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RIssuesAllpluginTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\RIssuesAllplugin'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRIssuesAllpluginQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RIssuesAllplugin::setDeleted()
     * @see RIssuesAllplugin::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRIssuesAllpluginQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RIssuesAllpluginTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RIssuesAllpluginTableMap::COL__ISSUEID)) {
            $modifiedColumns[':p' . $index++]  = '_issueid';
        }
        if ($this->isColumnModified(RIssuesAllpluginTableMap::COL__PLUGINID)) {
            $modifiedColumns[':p' . $index++]  = '_pluginid';
        }

        $sql = sprintf(
            'INSERT INTO R_issues_allplugin (%s) VALUES (%s)',
    ...
    {
        $pos = RIssuesAllpluginTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['RIssuesAllplugin'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RIssuesAllplugin'][$this->hashCode()] = true;
        $keys = RIssuesAllpluginTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RIssuesAllpluginTableMap::COL__ISSUEID)) {
            $criteria->add(RIssuesAllpluginTableMap::COL__ISSUEID, $this->_issueid);
        }
        if ($this->isColumnModified(RIssuesAllpluginTableMap::COL__PLUGINID)) {
            $criteria->add(RIssuesAllpluginTableMap::COL__PLUGINID, $this->_pluginid);
        }
    ...
    {
        $criteria = ChildRIssuesAllpluginQuery::create();
        $criteria->add(RIssuesAllpluginTableMap::COL__ISSUEID, $this->_issueid);
        $criteria->add(RIssuesAllpluginTableMap::COL__PLUGINID, $this->_pluginid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \RIssuesAllplugin (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \RIssuesAllplugin Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(RIssuesAllpluginTableMap::DEFAULT_STRING_FORMAT);
    }
