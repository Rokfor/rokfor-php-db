...
abstract class Contributionscache implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ContributionscacheTableMap';
    ...
    /**
     * Compares this with another <code>Contributionscache</code> instance.  If
     * <code>obj</code> is an instance of <code>Contributionscache</code>, delegates to
     * <code>equals(Contributionscache)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Contributionscache The current object, for fluid interface
     */
    ...
    /**
     * Get the [_signature] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ContributionscacheTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [_signature] column.
     *
    ...
    public function setSignature($v)
    {
        ...
        if ($this->_signature !== $v) {
            $this->_signature = $v;
            $this->modifiedColumns[ContributionscacheTableMap::COL__SIGNATURE] = true;
        }
    ...
    public function setForcontribution($v)
    {
        ...
        if ($this->_forcontribution !== $v) {
            ...
            $this->modifiedColumns[ContributionscacheTableMap::COL__FORCONTRIBUTION] = true;
        }
    ...
    /**
     * Set the value of [_cache] column.
     *
     * @param string $v new value
     * @return $this|\Contributionscache The current object (for fluent API support)
     */
    public function setCache($v)
    {
        ...
        if ($this->_cache !== $v) {
            $this->_cache = $v;
            $this->modifiedColumns[ContributionscacheTableMap::COL__CACHE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ContributionscacheTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ContributionscacheTableMap::translateFieldName('Signature', TableMap::TYPE_PHPNAME, $indexType)];
            $this->_signature = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContributionscacheTableMap::translateFieldName('Forcontribution', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildContributionscacheQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Contributionscache::setDeleted()
     * @see Contributionscache::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildContributionscacheQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ContributionscacheTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ContributionscacheTableMap::COL__SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '_signature';
        }
        if ($this->isColumnModified(ContributionscacheTableMap::COL__FORCONTRIBUTION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case '_signature':
                        $stmt->bindValue($identifier, $this->_signature, PDO::PARAM_STR);
                        break;
    ...
    {
        $pos = ContributionscacheTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Contributionscache'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Contributionscache'][$this->hashCode()] = true;
        $keys = ContributionscacheTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Contributionscache
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setForcontribution($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContributionscacheTableMap::COL_ID)) {
            $criteria->add(ContributionscacheTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ContributionscacheTableMap::COL__SIGNATURE)) {
            $criteria->add(ContributionscacheTableMap::COL__SIGNATURE, $this->_signature);
        }
        if ($this->isColumnModified(ContributionscacheTableMap::COL__FORCONTRIBUTION)) {
            $criteria->add(ContributionscacheTableMap::COL__FORCONTRIBUTION, $this->_forcontribution);
        }
        if ($this->isColumnModified(ContributionscacheTableMap::COL__CACHE)) {
    ...
    {
        $criteria = ChildContributionscacheQuery::create();
        $criteria->add(ContributionscacheTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Contributionscache (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Contributionscache Clone of current object.
     * @throws PropelException
     */
    ...
    public function getContributions(ConnectionInterface $con = null)
    {
        if ($this->aContributions === null && ($this->_forcontribution !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContributions->addContributionscaches($this);
             */
        }
    ...
    {
        if (null !== $this->aContributions) {
            $this->aContributions->removeContributionscache($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ContributionscacheTableMap::DEFAULT_STRING_FORMAT);
    }
